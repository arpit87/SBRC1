...
public class EventsLoggingProvider extends ContentProvider {
    ...
    private static final String TAG = "in.co.hopin.provider.EventsLoggingProvider";
    public final static String AUTHORITY = "in.co.hopin.provider.EventsLoggingProvider";
